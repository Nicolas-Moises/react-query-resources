    ...
    <section className="overflow-x-hidden">
      ...
      <div className="home-container flex items-center mt-[90px] gap-2 flex-col-reverse sm:flex-row">
        <div className="sm:mt-8">
          <motion.h1 {...fadeAnimProps} 
          className="text-4xl sm:text-[40px] sm:leading-[50px] md:text-[50px] md:leading-[60px] lg:text-[70px] lg:leading-[80px] font-semibold text-slate-800" style={{
